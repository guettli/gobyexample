...
function makeLineDarker() {
    ...
    // Remove 'darker' class from all spans
    lines.forEach(span => span.classList.remove('darker'));

    const currentSpan = lines[darkerLine];
    currentSpan.classList.add('darker');

    // Scroll to make the current line in the middle of the screen
    currentSpan.scrollIntoView({
        behavior: 'smooth',
        block: 'center',
        inline: 'nearest' // Keeps horizontal alignment consistent
    });
